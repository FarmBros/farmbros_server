...
from routes import user_routes, farm_routes, plot_routes, service_routes, crop_routes, planted_crop_routes, animal_type_routes, animal_routes
...
app.include_router(animal_type_routes.router)
