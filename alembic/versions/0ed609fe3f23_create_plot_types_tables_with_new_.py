"""Create plot types tables with new structure

Revision ID: 0ed609fe3f23
Revises: 8fd931069047
Create Date: 2025-10-07 20:59:39.267434
...
revision: str = '0ed609fe3f23'
down_revision: Union[str, Sequence[str], None] = '8fd931069047'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_field_plot_types_id'), 'field_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_field_plot_types_uuid'), 'field_plot_types', ['uuid'], unique=True)
    
    # Create barn_plot_types table
    ...
    op.create_index(op.f('ix_barn_plot_types_id'), 'barn_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_barn_plot_types_uuid'), 'barn_plot_types', ['uuid'], unique=True)
    
    # Create pasture_plot_types table
    ...
    op.create_index(op.f('ix_pasture_plot_types_id'), 'pasture_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_pasture_plot_types_uuid'), 'pasture_plot_types', ['uuid'], unique=True)
    
    # Create greenhouse_plot_types table
    ...
    op.create_index(op.f('ix_greenhouse_plot_types_id'), 'greenhouse_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_greenhouse_plot_types_uuid'), 'greenhouse_plot_types', ['uuid'], unique=True)
    
    # Create chicken_pen_plot_types table
    ...
    op.create_index(op.f('ix_chicken_pen_plot_types_id'), 'chicken_pen_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_chicken_pen_plot_types_uuid'), 'chicken_pen_plot_types', ['uuid'], unique=True)
    
    # Create cow_shed_plot_types table
    ...
    op.create_index(op.f('ix_cow_shed_plot_types_id'), 'cow_shed_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_cow_shed_plot_types_uuid'), 'cow_shed_plot_types', ['uuid'], unique=True)
    
    # Create fish_pond_plot_types table
    ...
    op.create_index(op.f('ix_fish_pond_plot_types_id'), 'fish_pond_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_fish_pond_plot_types_uuid'), 'fish_pond_plot_types', ['uuid'], unique=True)
    
    # Create residence_plot_types table
    ...
    op.create_index(op.f('ix_residence_plot_types_id'), 'residence_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_residence_plot_types_uuid'), 'residence_plot_types', ['uuid'], unique=True)
    
    # Create natural_area_plot_types table
    ...
    op.create_index(op.f('ix_natural_area_plot_types_id'), 'natural_area_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_natural_area_plot_types_uuid'), 'natural_area_plot_types', ['uuid'], unique=True)
    
    # Create water_source_plot_types table
    ...
    op.create_index(op.f('ix_water_source_plot_types_id'), 'water_source_plot_types', ['id'], unique=False)
    op.create_index(op.f('ix_water_source_plot_types_uuid'), 'water_source_plot_types', ['uuid'], unique=True)


def downgrade() -> None:
    """Downgrade schema."""
    # Drop all plot type tables
    op.drop_index(op.f('ix_water_source_plot_types_uuid'), table_name='water_source_plot_types')
    op.drop_index(op.f('ix_water_source_plot_types_id'), table_name='water_source_plot_types')
