...
Revision ID: d8e4ec6bbe7f
Revises: 2c47eab5e3d0
Create Date: 2025-08-21 22:20:31.998467
...
revision: str = 'd8e4ec6bbe7f'
down_revision: Union[str, Sequence[str], None] = '2c47eab5e3d0'
...
def upgrade() -> None:
    ...
    sa.Column('plot_type', sa.Enum('CROP', 'LIVESTOCK', 'MIXED', 'FORESTRY', 'AQUACULTURE', 'GREENHOUSE', 'ORCHARD', 'PASTURE', name='plottype'), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'FALLOW', 'PREPARING', 'HARVESTED', 'MAINTENANCE', name='plotstatus'), nullable=False),
    sa.Column('boundary', Geometry(geometry_type='POLYGON', dimension=2, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry', nullable=False), nullable=False),
    sa.Column('centroid', Geometry(geometry_type='POINT', dimension=2, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
    ...
    sa.Column('livestock_type', sa.String(length=100), nullable=True),
    sa.Column('livestock_count', sa.Integer(), nullable=True),
    sa.Column('grazing_capacity', sa.Integer(), nullable=True),
    ...
    op.create_geospatial_index('idx_plots_boundary', 'plots', ['boundary'], unique=False, postgresql_using='gist', postgresql_ops={})
    op.create_geospatial_index('idx_plots_centroid', 'plots', ['centroid'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    # op.drop_geospatial_index(op.f('idx_tiger_state_the_geom_gist'), table_name='state', postgresql_using='gist', column_name='the_geom')
    ...
    # op.drop_geospatial_index(op.f('tiger_faces_the_geom_gist'), table_name='faces', postgresql_using='gist', column_name='the_geom')
    ...
    # op.drop_geospatial_index(op.f('tiger_place_the_geom_gist'), table_name='place', postgresql_using='gist', column_name='the_geom')
    ...
    # op.drop_geospatial_index(op.f('idx_tiger_edges_the_geom_gist'), table_name='edges', postgresql_using='gist', column_name='the_geom')
    ...
    # op.drop_geospatial_index(op.f('idx_addrfeat_geom_gist'), table_name='addrfeat', postgresql_using='gist', column_name='the_geom')
...
def downgrade() -> None:
    ...
    # )
    # op.drop_geospatial_index('idx_plots_centroid', table_name='plots', postgresql_using='gist', column_name='centroid')
    # op.drop_geospatial_index('idx_plots_boundary', table_name='plots', postgresql_using='gist', column_name='boundary')
    # op.drop_geospatial_table('plots')
    # ### end Alembic commands ###
