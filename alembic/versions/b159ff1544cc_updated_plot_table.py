...
Revision ID: b159ff1544cc
Revises: 634b2241e941
Create Date: 2025-10-06 20:10:51.116913
...
revision: str = 'b159ff1544cc'
down_revision: Union[str, Sequence[str], None] = '634b2241e941'
...
def upgrade() -> None:
    ...
    op.drop_geospatial_index(op.f('idx_farms_boundary'), table_name='farms', postgresql_using='gist', column_name='boundary')
    op.drop_geospatial_index(op.f('idx_farms_centroid'), table_name='farms', postgresql_using='gist', column_name='centroid')

    op.drop_geospatial_index(op.f('idx_plots_boundary'), table_name='plots', postgresql_using='gist', column_name='boundary')
    op.drop_geospatial_index(op.f('idx_plots_centroid'), table_name='plots', postgresql_using='gist', column_name='centroid')
...
def downgrade() -> None:
    ...
    op.create_geospatial_index(op.f('idx_addrfeat_geom_gist'), 'addrfeat', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index(op.f('tiger_place_the_geom_gist'), 'place', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index(op.f('idx_tiger_edges_the_geom_gist'), 'edges', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_table('plots',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    ...
    sa.Column('plot_number', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('plot_type', postgresql.ENUM('CROP', 'LIVESTOCK', 'MIXED', 'FORESTRY', 'AQUACULTURE', 'GREENHOUSE', 'ORCHARD', 'PASTURE', name='plottype'), autoincrement=False, nullable=False),
    sa.Column('status', postgresql.ENUM('ACTIVE', 'FALLOW', 'PREPARING', 'HARVESTED', 'MAINTENANCE', name='plotstatus'), autoincrement=False, nullable=False),
    sa.Column('boundary', Geometry(geometry_type='POLYGON', dimension=2, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry', nullable=False, _spatial_index_reflected=True), autoincrement=False, nullable=False),
    sa.Column('centroid', Geometry(geometry_type='POINT', dimension=2, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True), autoincrement=False, nullable=True),
    sa.Column('area_sqm', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('elevation', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('slope', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('soil_type', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('ph_level', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('nitrogen_level', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('phosphorus_level', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('potassium_level', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('organic_matter', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('current_crop', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('crop_variety', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('planting_date', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('expected_harvest_date', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('last_harvest_date', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('livestock_type', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('livestock_count', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('grazing_capacity', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('irrigation_type', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('water_source', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('notes', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['farm_id'], ['farms.id'], name=op.f('plots_farm_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('plots_pkey')),
    sa.UniqueConstraint('uuid', name=op.f('plots_uuid_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_geospatial_index(op.f('idx_plots_centroid'), 'plots', ['centroid'], unique=False, postgresql_using='gist', postgresql_ops={})
    op.create_geospatial_index(op.f('idx_plots_boundary'), 'plots', ['boundary'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index(op.f('idx_tiger_state_the_geom_gist'), 'state', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_table('farms',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('uuid', sa.VARCHAR(length=36), autoincrement=False, nullable=True),
    sa.Column('name', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('owner_id', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('boundary', Geography(geometry_type='POLYGON', srid=4326, dimension=2, spatial_index=False, from_text='ST_GeogFromText', name='geography', nullable=False, _spatial_index_reflected=True), autoincrement=False, nullable=False),
    sa.Column('centroid', Geography(geometry_type='POINT', srid=4326, dimension=2, spatial_index=False, from_text='ST_GeogFromText', name='geography', _spatial_index_reflected=True), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('area_sqm', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['owner_id'], ['users.uuid'], name=op.f('farms_owner_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('farms_pkey')),
    sa.UniqueConstraint('uuid', name=op.f('farms_uuid_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_geospatial_index(op.f('idx_farms_centroid'), 'farms', ['centroid'], unique=False, postgresql_using='gist', postgresql_ops={})
    op.create_geospatial_index(op.f('idx_farms_boundary'), 'farms', ['boundary'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    sa.Column('login_type', postgresql.ENUM('PASSWORD', 'GOOGLE_AUTH', 'BOTH', name='logintype'), server_default=sa.text("'PASSWORD'::logintype"), autoincrement=False, nullable=False),
    ...
    op.create_geospatial_index(op.f('tiger_faces_the_geom_gist'), 'faces', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
